    ...
    <div>
        ...
        <div v-else>
            ...
            <div v-if="showPreview" class="mb-3">
                <button @click="showingPreview = !showingPreview" type="button" class="btn btn-flat">
                    <img :src="uri" class="w-4 rounded-sm mr-2" />
                ...
                <img v-if="showingPreview" :src="uri" class="w-24 rounded-md" />
            </div>
